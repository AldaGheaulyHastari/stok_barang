...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-file-text"></i> Laporan Bulanan Pengiriman Barang</h4>
    </div>
</div>
<hr class="mt-0" />
<?php
...
<table class="table table-sm table-bordered mt-3">
    ...
    <tbody>
        ...
        if ($data->num_rows() > 0) {
            ...
            echo '<td><b><span class="float-left"></span><span class="float-right">' . number_format($total, 0, ',', '.') . '</span></b></td>';
            echo '</tr>';
