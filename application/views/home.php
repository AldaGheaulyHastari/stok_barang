...
<div class="alert alert-info" role="alert">
    ...
    <hr>
    <h4 class="alert-heading"><i class="fa fa-info-circle"></i> Selamat Datang di <b>Instalasi Sterilisasi Terpusat</b> | Salam Steril by <a href='https://www.rspjember.jatimprov.go.id/' title='rspjember.jatimprov.go.id/' target='_blank'>Rumah Sakit Paru Jember</a>
	</h4>
