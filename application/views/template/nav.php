...
<nav id="sidebar">
    <div class="p-4 pt-5">
        <a href="<?= site_url(); ?>"class="img logo rounded-circle mb-3" style="background-image: url(<?= base_url('assets/img/Untitled.png'); ?>);"></a>
        ...
        <ul class="list-unstyled components mb-5">
            ...
            ?>
                <li <?= (in_array(strtolower($this->uri->segment(1)), ['barang', 'tambah_barang', 'edit_barang'])) ? 'class="active"' : ''; ?>>
                    <a href="<?= site_url('barang'); ?>"><i class="fa fa-cubes"></i> Data Instrumen Dan BHP</a>
                </li>
...
ooggh
        ...
        <div class="footer">
            <p>
                ...
                </script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">IST</a> | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>INSTALASI STERILISASI TERPUSAT</a>
