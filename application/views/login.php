...
<head>
    ...
    <link rel="shortcut icon" href="<?= base_url('assets/img/cetak.ico'); ?>">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center mt-5 mb-3">
                <img src="<?= base_url('assets/img/Untitled.png'); ?>" class="login" />
                <img src="<?= base_url('assets/img/Untitled1.png'); ?>" class="login" />
                <h3 class="text-white mt-2">INSTALASI STERILISASI TERPUSAT</h3>
<br><center><p>Repost by <a href='https://www.rspjember.jatimprov.go.id/' title='rspjember.jatimprov.go.id/' target='_blank'>RUMAH SAKIT PARU JEMBER</a></p></center>
